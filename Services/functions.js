  ...
  if (token) {
    try {
      const response = await axios.get(
        "https://houseofhilda.onrender.com/api/v1/userverification/getSessionUser",
        {
          headers: {
...
export const changePassword = async (
  ...
  axios
    .post(
      "https://houseofhilda.onrender.com/api/v1/userverification/resetpassword",
      {
        password,
        userId,
      }
...
export const registerUser = async (
  ...
  axios
    .post(
      "https://houseofhilda.onrender.com/api/v1/userverification/registeruser",
      user
    )
    .then((resp) => {
...
export const emailResendOTP = async (
  ...
  axios
    .post(
      "https://houseofhilda.onrender.com/api/v1/userverification/resendotp",
      user
    )
    .then((resp) => {
...
export const forgetPassword = async (
  ...
  axios
    .post(
      "https://houseofhilda.onrender.com/api/v1/userverification/forgotPassword",
      user
    )
    .then((resp) => {
      console.log(resp.data);
...
export const fogetPwEnterOTP = async (
  ...
  axios
    .post(
      "https://houseofhilda.onrender.com/api/v1/userverification/resetpasswordOTP",
      {
        userId,
        otp,
      }
...
export const enterOTP = async (
  ...
  axios
    .post(
      "https://houseofhilda.onrender.com/api/v1/userverification/verifyotp",
      {
        userId,
        otp,
      }
...
const singleTransaction = async (transactID) => {
  ...
  const { data } = await axios.get(
    `https://houseofhilda.onrender.com/api/v1/transaction/getsingletransaction/${transactID}`,
    {
      headers: {
        authorization: `Bearer ${token}`,
      },
...
const updateTransaction = async (transactID, transactionStatus) => {
  ...
  await axios
    .patch(
      "https://houseofhilda.onrender.com/api/v1/transaction/updatetransaction/" +
        `${transactID}`,
      {
...
export const transactionStatus = async (
  ...
  try {
    const response = await axios.get(
      ...
      {
        headers: {
          Authorization: `Bearer sk_test_61734ec51de3aa54ad6feb5079b30b4e78aecc67`,
        },
      }
    );
...
export const allTransactions = async () => {
  ...
  try {
    const response = await axios.get(
      "https://houseofhilda.onrender.com/api/v1/transaction/alltransaction",
      {
        headers: {
          authorization: `Bearer ${token}`,
        },
...
export const allUsers = async () => {
  ...
  try {
    const response = await axios.get(
      "https://houseofhilda.onrender.com/api/v1/userverification/allusers",
      {
        headers: {
          authorization: `Bearer ${token}`,
        },
...
const singleUser = async (userID) => {
  const token = Cookies.get("JWTtoken");
  const { data } = await axios.get(
    `https://houseofhilda.onrender.com/api/v1/userverification/getsingleuser/${userID}`,
    {
      headers: {
        authorization: `Bearer ${token}`,
      },
...
export const addToCart = async (productData, productID) => {
  ...
  try {
    const { data } = await axios.post(
      "https://houseofhilda.onrender.com/api/v1/cart/addtocart",
      product,
      {
        headers: {
          authorization: `Bearer ${token}`,
...
export const allCartItem = async () => {
  ...
  if (token) {
    try {
      const response = await axios.get(
        "https://houseofhilda.onrender.com/api/v1/cart/allcart",
        {
          headers: {
            authorization: `Bearer ${token}`,
          },
...
export const deleteCartItem = async (_id) => {
  ...
  try {
    const { data } = await axios.delete(
      `https://houseofhilda.onrender.com/api/v1/cart/deletecart/${_id}`,
      {
        headers: {
          authorization: `Bearer ${token}`,
        },
...
export const checkOut = async (productData, setTransactionDetails) => {
  ...
  axios
    .post(
      "https://houseofhilda.onrender.com/api/v1/transaction/posttransaction",
      productData,
      {
        headers: {
          authorization: `Bearer ${token}`,
